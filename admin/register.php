...
<head>
    ...
    <meta name="description" content="Register as superadmin for Bizzbel Data Intelligence.">
    <meta name="keywords" content="Bizzbel Data Intelligence, Superadmin Register, admin access">
    <title>Superadmin Register - Bizzbel Data Intelligence</title>
...
<body data-theme="light">
    ...
    <script>
        ...
        fetch('api/check-superadmin.php')
            .then(response => response.json())
            .then(data => {
                if (data.superadmin_exists) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Access Denied',
                        text: 'Superadmin already registered. Please log in.',
                        timer: 3000,
