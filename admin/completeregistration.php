...
<head>
    ...
    <meta name="description" content="Complete your admin registration for Bizzbel Data Intelligence.">
    <meta name="keywords" content="Bizzbel Data Intelligence, Complete Registration, admin access">
    <title>Complete Registration - Bizzbel Data Intelligence</title>
...
<body data-theme="light">
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form id="complete-registration-form" action="api/complete-registration.php" method="POST">
                ...
                <div class="form-group">
                    <input type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" required aria-label="Confirm Password">
                    <i class="fas fa-eye password-toggle" id="confirmPassword-toggle"></i>
                </div>
    ...
    <script>
        ...
        if (!token) {
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Invalid or missing registration token.',
                timer: 3000,
